...
export default function ProfileDiscoveryCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* Nome, objetivo, badges e botão favoritar */}
        <div
          style={{
            display: 'flex',
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            <h2 style={{ margin: 0, fontSize: 30, fontWeight: 700, color: '#0f172a', lineHeight: 1.2 }}>
              {profile.name}
            </h2>
            {profile.objective && (
              <p style={{ margin: 0, marginTop: 6, fontSize: 14, fontWeight: 600, color: '#65a30d', display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', marginTop: 8 }}>
                ...
                {profileType && (
                  <span style={{
                    ...
                    padding: '6px 12px',
                    borderRadius: 8,
                    background: profileType === 'Coprodutor' ? 'rgba(139, 92, 246, 0.15)' : 'rgba(190, 242, 100, 0.35)',
                    border: `1px solid ${profileType === 'Coprodutor' ? '#8b5cf6' : '#84cc16'}`,
          ...
          {onFavorite && (
            <button
              ...
              style={{
                ...
                background: '#fff',
                color: isFavorited ? '#BEF264' : '#94a3b8',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                cursor: 'pointer',
            ...
            >
              <span className="material-symbols-outlined" style={{ fontSize: 22, fontVariationSettings: isFavorited ? '"FILL" 1' : '"FILL" 0' }}>star</span>
            </button>
          )}
        </div>

        {/* Grid Nicho + Interesses */}
