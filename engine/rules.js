function analyzeCampaign(campaign, productPrice, hasPreCheckout) {
  ...
  const requiredMetrics = ['spend', 'ctr_link', 'link_clicks', 'lp_views', 'checkouts'];
...
function analyzeAllCampaigns(campaigns, productPrice, hasPreCheckout) {
...
module.exports = { analyzeCampaign, analyzeAllCampaigns };
