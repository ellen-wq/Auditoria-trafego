-- ============================================================
-- Tabela de mensagens do Tinder do Fluxo (chat entre conexões)
-- Como executar: Supabase Dashboard > SQL Editor > New query >
--   cole este arquivo e execute (Run).
-- ============================================================

-- tinder_messages: mensagens entre dois usuários que fizeram conexão
...
COMMENT ON TABLE tinder_messages IS 'Mensagens trocadas entre usuários que fizeram conexão no Tinder do Fluxo';
